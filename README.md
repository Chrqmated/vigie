...
- **Domicile, Travail, favoris** et récents dans la recherche ; **étapes intermédiaires** (« + Étape ») ; **stations les moins chères** sur le trajet (prix en direct, détour estimé, ajout en étape d'un tap) ou autour de vous ; **toutes les stations de la zone affichée** sur la carte avec leur prix, colorées du moins cher (vert) au plus cher (rouge), fiche au tap.
